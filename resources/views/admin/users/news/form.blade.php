    ...
    <form method="post" action="{{route('admin.news.store')}}" enctype="multipart/form-data">
                ...
                <label for="0" >Titre</label>
                    ...
                    <div class="form-group ">
                            ...
                            <textarea name="body"  cols="30" rows="10" class="form-control  {{ $errors->has('body') ? ' is-invalid': ' ' }}" autofocus></textarea>
                                @if ($errors->has('body'))
                                    <span class="invalid-feedback" role="alert">
                  ...
                  <div class="custom-file row">
                     ...
                     <?php $i++; ?>
                      <option  value="{{$user->id}}">{{$i}}. {{$user->name}}</option>
                      @endforeach
                      </select>
                  ...
                  <div class="form-group ">
                    ...
                    <div class="form-group ">
                     ...
                     <?php $i++; ?>
                      <option  value="{{$province->id}}">{{$i}}. {{$province->nom}}</option>
                      @endforeach
                      </select>
